...
export default function Section1() {
  return (
    <div className="relative pt-48 h-dvh">
      <Image
      ...
      <div className="flex justify-center mb-10">
        <div className="text-xs text-center flex flex-col gap-10 w-[80%] px-5 py-10 shadow-[0_4px_30px_rgba(0,0,0,0.5)] bg-transparent rounded-3xl backdrop-blur-sm">
